...
- `ticket/[id]/` owns public reservation ticket display by ticket ID.
...
- Keep guest-facing money, cleaning fee, room type, and discount displays consistent with Convex-backed settings from `lib/store.js` and `lib/calc.js` formatting/calculations.

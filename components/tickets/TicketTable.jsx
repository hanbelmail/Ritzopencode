...
import TicketActionsDialog from "./TicketActionsDialog";
...
export default function TicketTable({ tickets, selectedIds, onSelectedIdsChange, visibleColumns = ticketTableColumnKeys, onVisibleColumnsChange, showColumnsButton = true, onStatusChange, onTicketUpdate }) {
  ...
  return (
    <div className="rounded-[12px] border border-[#e6dfd8] bg-[#faf9f5]">
      ...
      {showColumnsButton && (
        <div className="hidden justify-end border-t border-[#e6dfd8] px-4 py-3 md:flex">
          <DropdownMenu>

...
- Owns the guest-facing Sona AI concierge launcher and responsive conversation dialog used across public routes.
...
- Use only `/api/sara/chat` for conversation reads and writes; never call OpenAI or Convex Sona mutations from browser code.
...
- Display the configured exact Sona/Mike/private-condo opening message before guest input, keep the separate independent-service/not-official-hotel notice visible, and make human help available.

...
- `store.js` owns full-list and paginated reservation tickets/settings client hooks, persisted status constants, default/settings normalization, and legacy `ritz_*` localStorage migration keys.

...
const tools = [
  ...
  },
  {
    ...
    description: "List the contiguous available check-in/check-out ranges for one requested calendar month in Hawaii. Use for broad month availability questions. This does not hold dates.",
    strict: true,
    parameters: objectSchema({

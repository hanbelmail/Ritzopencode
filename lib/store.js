...
import { DEFAULT_SETTINGS, PAYMENT_METHODS, normalizeSaraBranding } from "@/lib/defaults";
import {
...
export function normalizeSettings(settings) {
  ...
  const saved = normalizeSaraBranding(settings);
  ...
  saved.tableColumnsButtonVisible = saved.tableColumnsButtonVisible !== false;

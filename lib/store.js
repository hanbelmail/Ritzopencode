...
export function normalizeSettings(settings) {
  ...
  if (saved.bookingRequestHotelAlertEnabled === undefined) {
    saved.bookingRequestHotelAlertEnabled = saved.bookingConfirmedHotelAlertEnabled;
  }
  delete saved.bookingConfirmedHotelAlertEnabled;
